...
const VARIABLE_SEEDS = [
  ...
  { name: "next_arrival_window",    sort_order: 62, resolved_from: "job-confirmation-context (live at dispatch)", description: "Arrival window for the next visit, e.g. 'between 7:30 AM and 8:30 AM' — the scheduled start plus/minus 30 minutes. Precomputed because a model doing this arithmetic gets hour and noon boundaries wrong. Blank on a DST fall-back night, where both bounds are the same wall-clock time; state the scheduled time alone then." },
