...
Job details:
- Job: ${d.jobName}
${optLine(d.ctx.job.description, `- Description: ${d.ctx.job.description}`)}${optLine(d.ctx.job.customer?.address, `- Address: ${d.ctx.job.customer?.address}`)}
...
${d.next
  ? `This is the first message — open by naming who you are and what this is about, then go straight into the goal below. E.g. "Hi, this is ${d.rep} with ${d.companyName || "us"} — I'm reaching out about the ${d.next.service_summary || d.next.service_line || "upcoming"} visit at ${d.siteName || "your site"} on ${d.next.scheduled_start_spoken}."`
  : `This is the first message — open by naming who you are and what this is about. E.g. "Hi, this is ${d.rep} with ${d.companyName || "us"} — I'm reaching out about the ${d.jobName}."`}
`;
...
• 2 or more upcoming: "We have ${d.counts.upcoming} visits coming up on this job. The next one is ${d.next?.scheduled_start_spoken} for your [service names]."
